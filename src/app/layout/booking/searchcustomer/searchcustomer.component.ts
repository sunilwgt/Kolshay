...
import { BookingService ,CompanyItem} from '../booking.service';
...
export class SearchCustomerComponent implements OnInit {
  ...
  constructor(
    ...
    public thisDialogRef: MatDialogRef<SearchCustomerComponent>,
  ...
  onselect(data , action) {
    ...
    this.bookingservice.selectcustomer(data);
    this.thisDialogRef.close(action);
